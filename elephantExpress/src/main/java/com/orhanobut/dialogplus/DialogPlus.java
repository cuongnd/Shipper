...
public class DialogPlus {
     ...
     * to set dialog_header_res/dialog_footer for the dialog content
     */
    ...
    /**
     * Listener for the user to take action by clicking views in dialog_header_res or dialog_footer
     */
    ...
    private DialogPlus(Builder builder) {
        ...
        rootView = (ViewGroup) inflater.inflate(R.layout.dialog_base_container, null);
     ...
     * @param title
     */
    public void setHeaderText(int resId, String title) {
        View v = headerView;
        if (v == null) return;
    ...
    public static class Builder {
        ...
        public Builder setAdapter(BaseAdapter adapter) {
            if (adapter == null) {
//                Log.w("DialogPlus", "You are not set the adapter,so you can't use the GridView or ListView.");
                return this;
                //throw new NullPointerException("Adapter may not be null"); //不让抛异常，显示普通View的时候不必须
            }
        ...
        /**
         * Set the dialog_footer view using the id of the layout resource
         */
        ...
        /**
         * Set the dialog_footer view using a view
         */
        ...
        /**
         * Set the dialog_header_res view using the id of the layout resource
         */
...
//        public Builder setHeader(int resourceId,String title){
//            this.headerViewResourceId = resourceId;
...
//        }
        ...
        /**
         * Set the dialog_header_res view using a view
         */
        ...
        /**
         * save margins to your outmost view which contains everything. As default they are 0
         * are applied
         */
        ...
        /**
         * save margins to your dialog. They are set to 0 except when gravity is center. In that case basic margins
         * are applied
         */
