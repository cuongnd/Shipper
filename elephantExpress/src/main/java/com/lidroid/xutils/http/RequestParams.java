...
public class RequestParams {
    ...
    /**
     * Adds a dialog_header_res to this message. The dialog_header_res will be appended to the end of the list.
     *
     * @param header
     */
    ...
    /**
     * Overwrites the first dialog_header_res with the same name.
     * The new dialog_header_res will be appended to the end of the list, if no dialog_header_res with the given name can be found.
     *
     * @param header
     */
