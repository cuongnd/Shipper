...
public class HttpHandler<T> extends PriorityAsyncTask<Object, Object, Void> implements RequestCallBackHandler {
    ...
    private boolean autoRename = false; // Whether rename the file by response dialog_header_res info when the download completely.
    private String charset; // The default charset of response dialog_header_res info.
