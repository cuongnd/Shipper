...
// [8]  MaxBytes: Max number of data bytes per region (including dialog_header_res).
...
// [16] Length of this blob (not including dialog_header_res)
// [20] Blob
//
...
public class DiskCache implements Closeable {
    ...
    // index dialog_header_res offset
    ...
    // mIndexHeader and index dialog_header_res in file should be kept sync.
...
//                Log.w(TAG, "cannot read dialog_header_res");
                return false;
            }

            if (readInt(buf, IH_MAGIC) != MAGIC_INDEX_FILE) {
//                Log.w(TAG, "cannot read dialog_header_res magic");
                return false;
            }
...
//                Log.w(TAG, "dialog_header_res checksum does not match");
                return false;
            }
...
//                Log.w(TAG, "cannot read blob dialog_header_res");
                return false;
            }
