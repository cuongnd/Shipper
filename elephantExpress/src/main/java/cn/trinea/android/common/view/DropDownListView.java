...
public class DropDownListView extends ListView implements OnScrollListener {
	...
	/** rate about drop down distance and dialog_header_res padding top when drop down **/
	private float headerPaddingTopRate = 1.5f;
	/** min distance which dialog_header_res can release to loading **/
	private int headerReleaseMinDistance;

	/** whether bottom listener has more **/
	private boolean hasMore = true;
	/** whether show dialog_footer loading progress bar when loading **/
	private boolean isShowFooterProgressBar = true;
	/** whether show dialog_footer when no more data **/
	private boolean isShowFooterWhenNoMore = false;

	private int currentScrollState;
	private int currentHeaderStatus;

	/** whether reached top, when has reached top, don't show dialog_header_res layout **/
	...
	/** dialog_header_res layout original height **/
	private int headerOriginalHeight;
	/** dialog_header_res layout original padding top **/
	...
	/**
	 * get whether show dialog_footer loading progress bar when loading
	 * 
	...
	/**
	 * set whether show dialog_footer loading progress bar when loading
	 * 
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		case MotionEvent.ACTION_UP:
			 ...
			 * dialog_header_res status is not HEADER_STATUS_LOADING
			 * <ul>
			 * <li>if current dialog_header_res status is HEADER_STATUS_RELEASE_TO_LOAD,
			 * call onDropDown.</li>
			 * <li>if current dialog_header_res status is HEADER_STATUS_DROP_DOWN_TO_LOAD,
			 * then set dialog_header_res status to HEADER_STATUS_CLICK_TO_LOAD and hide
			 * dialog_header_res layout.</li>
			 * </ul>
			 */
	...
	public void onScroll(AbsListView view, int firstVisibleItem,
		...
		if (isDropDownStyle) {
			if (currentScrollState == SCROLL_STATE_TOUCH_SCROLL
				 ...
				 * is scrolling and finger is on screen) and dialog_header_res status is
				 * not HEADER_STATUS_LOADING
				 * <ul>
				 * if dialog_header_res layout is visiable,
				 * <li>if height of dialog_header_res is higher than a fixed value, then
				 * set dialog_header_res status to HEADER_STATUS_RELEASE_TO_LOAD.</li>
				 * <li>else set dialog_header_res status to
				 * HEADER_STATUS_DROP_DOWN_TO_LOAD.</li>
				 * </ul>
				 * <ul>
				 * if dialog_header_res layout is not visiable,
				 * <li>set dialog_header_res status to HEADER_STATUS_CLICK_TO_LOAD.</li>
				 * </ul>
				 */
				 ...
				 * scrolling but finger has leave screen) and first item(dialog_header_res
				 * layout) is visible and dialog_header_res status is not
	 ...
	 * 
	 * @param secondText
	 *            display below dialog_header_res text, if null, not display
	 */
	...
	/**
	 * set dialog_header_res second text
	 * 
	 * @param secondText
	 *            secondText display below dialog_header_res text, if null, not display
	 */
	...
	/**
	 * OnDropDownListener, called when dialog_header_res released
	 * 
	...
	public interface OnDropDownListener {
		...
		/**
		 * called when dialog_header_res released
		 */
		public void onDropDown();
	}

	/**
	 * set second position visible(index is 1), because first position is dialog_header_res
	 * layout
	 */
	...
	/**
	 * get dialog_header_res layout view
	 * 
	 * @return
	 */
	...
	/**
	 * get rate about drop down distance and dialog_header_res padding top when drop down
	 * 
	...
	/**
	 * set rate about drop down distance and dialog_header_res padding top when drop down
	 * 
	...
	/**
	 * get min distance which dialog_header_res can release to loading
	 * 
	...
	/**
	 * set min distance which dialog_header_res can release to loading
	 * 
	...
	/***
	 * get dialog_header_res default text, default is
	...
	/**
	 * set dialog_header_res default text, default is
	 * R.string.drop_down_list_header_default_text
	 * 
	...
	/**
	 * get dialog_header_res pull text, default is R.string.drop_down_list_header_pull_text
	 * 
	 * @return
	 */
	...
	/**
	 * set dialog_header_res pull text, default is R.string.drop_down_list_header_pull_text
	 * 
	...
	/**
	 * get dialog_header_res release text, default is
	...
	/**
	 * set dialog_header_res release text, default is
	 * R.string.drop_down_list_header_release_text
	 * 
	...
	/**
	 * get dialog_header_res loading text, default is
	...
	/**
	 * set dialog_header_res loading text, default is
	 * R.string.drop_down_list_header_loading_text
	 * 
	...
	/**
	 * get dialog_footer default text, default is
	...
	/**
	 * set dialog_footer default text, default is
	 * R.string.drop_down_list_footer_default_text
	 * 
	...
	/**
	 * get dialog_footer loading text, default is
	...
	/**
	 * set dialog_footer loading text, default is
	 * R.string.drop_down_list_footer_loading_text
	 * 
	...
	/**
	 * get dialog_footer no more text, default is
	...
	/**
	 * set dialog_footer no more text, default is
	 * R.string.drop_down_list_footer_no_more_text
	 * 
	 ...
	 * onDropDownListener, when height of dialog_header_res layout lower than a value
	 **/
	 ...
	 * dialog_header_res layout higher than a value
	 **/
	...
	/**
	 * set dialog_header_res status to {@link #HEADER_STATUS_CLICK_TO_LOAD}
	 */
	...
	/**
	 * set dialog_header_res status to {@link #HEADER_STATUS_DROP_DOWN_TO_LOAD}
	 */
	...
	/**
	 * set dialog_header_res status to {@link #HEADER_STATUS_RELEASE_TO_LOAD}
	 */
	...
	/**
	 * set dialog_header_res status to {@link #HEADER_STATUS_LOADING}
	 */
	...
	/**
	 * adjust dialog_header_res padding according to motion event
	 * 
	 * @param ev
	 */
	private void adjustHeaderPadding(MotionEvent ev) {
		// adjust dialog_header_res padding according to motion event history
	...
	/**
	 * reset dialog_header_res padding
	 */
	...
	/**
	 * measure dialog_header_res layout
	 * 
	 * @param child
	 */
