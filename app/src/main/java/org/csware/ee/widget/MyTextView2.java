...
public class MyTextView2 extends TextView{
	...
	public MyTextView2(Context context, AttributeSet attrs) {
		...
		textSize = attrs.getAttributeIntValue(namespace, "textSize", 34);
		textColor = attrs.getAttributeIntValue(namespace, "textColor",getResources().getColor(R.color.label_text_gray));
		paddingLeft = attrs.getAttributeIntValue(namespace, "paddingLeft", 30);
