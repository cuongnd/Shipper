...
package org.csware.ee.widget.crop;
    ...
    private void setupFromIntent() {
        ...
        if (sourceUri != null) {
            ...
            try {
                ...
                Tracer.e("Error reading image: " + e.getMessage(), e+"");
                setResultException(e);
            } catch (OutOfMemoryError e) {
                Tracer.e("OOM reading image: " + e.getMessage(), e + "");
                UserAuthActivity.tempFile = ImageByAndroid.getFile(ImageByAndroid.avatorpath + "/" + UserAuthActivity.PHOTO_FILE_NAME);
                ImageByAndroid.startPhotoZoom(sourceUri, this, Uri.fromFile(UserAuthActivity.tempFile),false);
                SharedPreferences preferences = getSharedPreferences("Crop",MODE_PRIVATE);
                SharedPreferences.Editor editor = preferences.edit();
                editor.putBoolean("Crop",true).commit();
//                setResultException(e);
            } finally {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if(requestCode == UserAuthActivity.PHOTO_REQUEST_CUT && data != null){
            Tracer.e("CropImageActivity",UserAuthActivity.PHOTO_REQUEST_CUT+"");
            setResult(UserAuthActivity.PHOTO_REQUEST_CUT);
